...
export function Header({
  ...
  return (
    <header
      className="fixed right-0 top-0 z-30 border-b border-zinc-200/80 bg-white/85 px-6 py-5 backdrop-blur-xl transition-all duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] dark:border-zinc-800/80 dark:bg-zinc-950/85 lg:px-8 max-md:border-b-0 max-md:border-transparent max-md:bg-transparent max-md:px-4 max-md:py-4 max-md:backdrop-blur-none max-md:pointer-events-none max-md:dark:bg-transparent"
