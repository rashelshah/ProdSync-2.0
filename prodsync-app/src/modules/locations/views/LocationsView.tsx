  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center sm:px-4 sm:py-6">
      <button
        ...
        onClick={onClose}
      />
      <Surface variant="raised" padding="none" className={`relative z-10 w-full overflow-hidden rounded-t-[32px] sm:rounded-[32px] flex flex-col max-h-[90vh] ${maxWidth}`}>
        <div className="border-b border-zinc-200 px-5 py-4 dark:border-zinc-800 sm:px-6 shrink-0">
        ...
        <div className="overflow-y-auto p-4 sm:p-6 shrink">
          {children}
        </div>
        {footer && (
          <div className="border-t border-zinc-200 px-5 py-4 dark:border-zinc-800 sm:px-6 shrink-0">
            {footer}
          </div>
        )}
      </Surface>
...
export function LocationsView() {
  ...
  const locationsQuery = useInfiniteQuery({
    ...
    queryFn: ({ pageParam = 1 }) => locationsService.getLocations(activeProjectId!, { page: pageParam, pageSize: 12 } satisfies LocationListFilters),
  ...
  const renderOverviewPanel = () => {
    ...
    return (
      <div className="grid gap-6 xl:grid-cols-[1.25fr_0.75fr]">
        <div className="md:rounded-[32px] md:border md:border-zinc-200 md:bg-white md:p-6 lg:p-8 md:dark:border-zinc-800 md:dark:bg-zinc-950">
          <div className="section-heading hidden md:block">
            <div>
              <p className="section-kicker">Readiness</p>
              <h3 className="section-title">Production Status</h3>
            </div>
          </div>
          <div className="flex flex-col gap-4 mt-0 md:mt-5 lg:flex-row lg:items-start lg:justify-between">
          ...
          <div className="mt-6 grid grid-cols-2 gap-4 md:grid-cols-3 xl:grid-cols-4">
            <div className="rounded-[26px] border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-800 dark:bg-zinc-900 flex flex-col justify-between">
              <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-zinc-500 dark:text-zinc-400">Shoot Readiness</p>
              <div className="mt-2">
                <p className="text-2xl font-semibold text-zinc-900 dark:text-white">{selectedLocation.readiness?.readinessScore ?? 0}</p>
                <p className="mt-1 text-[9px] uppercase tracking-wider text-orange-600 dark:text-orange-400 line-clamp-1">{selectedLocation.readiness?.readinessStatus ? labelize(selectedLocation.readiness.readinessStatus) : 'Not ready'}</p>
              </div>
            </div>
            <div className="rounded-[26px] border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-800 dark:bg-zinc-900 flex flex-col justify-between">
              <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-zinc-500 dark:text-zinc-400">Perms Readiness</p>
              <div className="mt-2">
                <p className="text-2xl font-semibold text-zinc-900 dark:text-white">{overviewStats.permissionsScore}</p>
                <p className="mt-1 text-[9px] uppercase tracking-wider text-zinc-500 dark:text-zinc-400 line-clamp-1">Approved / total</p>
              </div>
            </div>
            <div className="rounded-[26px] border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-800 dark:bg-zinc-900 flex flex-col justify-between">
              <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-zinc-500 dark:text-zinc-400">Risk Score</p>
              <div className="mt-2">
                <p className="text-2xl font-semibold text-zinc-900 dark:text-white">{selectedLocation.riskLevel === 'high' ? '90' : selectedLocation.riskLevel === 'medium' ? '60' : '30'}</p>
                <p className="mt-1 text-[9px] uppercase tracking-wider text-red-500 dark:text-red-400 line-clamp-1">{labelize(selectedLocation.riskLevel)} risk</p>
              </div>
            </div>
            <div className="rounded-[26px] border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-800 dark:bg-zinc-900 flex flex-col justify-between">
              <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-zinc-500 dark:text-zinc-400">Project Spend</p>
              <div className="mt-2">
                <p className="text-2xl font-semibold text-zinc-900 dark:text-white">{formatCurrency(overviewStats.totalCost)}</p>
                <p className="mt-1 text-[9px] uppercase tracking-wider text-zinc-500 dark:text-zinc-400 line-clamp-1">Pending: {overviewStats.pendingCosts}</p>
              </div>
            </div>
            <div className="rounded-[26px] border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-800 dark:bg-zinc-900 flex flex-col justify-between">
              <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-zinc-500 dark:text-zinc-400">Document Count</p>
              <div className="mt-2">
                <p className="text-2xl font-semibold text-zinc-900 dark:text-white">{overviewStats.documentCount}</p>
                <p className="mt-1 text-[9px] uppercase tracking-wider text-zinc-500 dark:text-zinc-400 line-clamp-1">Secure files</p>
              </div>
            </div>
            <div className="rounded-[26px] border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-800 dark:bg-zinc-900 flex flex-col justify-between">
              <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-zinc-500 dark:text-zinc-400">Gallery Count</p>
              <div className="mt-2">
                <p className="text-2xl font-semibold text-zinc-900 dark:text-white">{overviewStats.mediaCount}</p>
                <p className="mt-1 text-[9px] uppercase tracking-wider text-zinc-500 dark:text-zinc-400 line-clamp-1">Images & videos</p>
              </div>
            </div>
            <div className="rounded-[26px] border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-800 dark:bg-zinc-900 flex flex-col justify-between col-span-2 md:col-span-1 xl:col-span-2">
              ...
              <div className="mt-2">
                {selectedDetailData?.timeline[0] ? (
                  <>
                    <p className="text-base font-semibold text-zinc-900 dark:text-white line-clamp-1">{selectedDetailData.timeline[0].title}</p>
                    <p className="mt-1 text-[9px] uppercase tracking-wider text-zinc-500 dark:text-zinc-400 line-clamp-1">{formatDate(selectedDetailData.timeline[0].eventAt)} · {timeAgo(selectedDetailData.timeline[0].eventAt)}</p>
                  </>
                ) : (
          ...
          {PERMISSION_CHECKLIST.map(item => {
            ...
            return (
              <div key={item.key} className="rounded-[28px] border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-800 dark:bg-zinc-900">
                <div 
                  className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between cursor-pointer md:cursor-auto"
                  onClick={() => {
                    if (window.innerWidth < 768) {
                      setOpenPermissionId(openPermissionId === item.key ? null : item.key)
                    }
                  }}
                >
                ...
                <div className={`mt-5 grid gap-4 md:grid-cols-2 xl:grid-cols-4 ${openPermissionId === item.key ? 'grid' : 'hidden'} md:grid`}>
                  <Field label="Status">
                    <Select
                      value={draft.status}
                ...
                <div className={`mt-4 grid gap-4 xl:grid-cols-[1fr_220px] ${openPermissionId === item.key ? 'grid' : 'hidden'} md:grid`}>
                  <Field label="Notes">
                    <Textarea
                      value={draft.notes ?? ''}
                      onChange={event => setPermissionDrafts(current => ({
                ...
                <div className="relative md:hidden">
                  ...
                  {openMenuId === location.id && (
                    <>
                      ...
                      <div className="absolute right-0 top-12 z-50 w-48 rounded-[20px] border border-[color:var(--app-border)] bg-[color:var(--app-surface-strong)] p-2 shadow-xl">
                        <button
                          type="button"
                          onClick={() => {
                            setOpenMenuId(null)
                          ...
                          className="flex w-full items-center gap-3 rounded-[12px] px-3 py-2 text-left text-sm font-medium text-zinc-900 transition hover:bg-zinc-50 dark:text-white dark:hover:bg-zinc-800"
                        >
                        ...
                        <button
                          ...
                          className="flex w-full items-center gap-3 rounded-[12px] px-3 py-2 text-left text-sm font-medium text-red-600 transition hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-500/10"
                        >
                          <span className="material-symbols-outlined text-[18px]">delete</span>
                          Delete
                        </button>
    ...
    <div className="min-h-screen bg-[color:var(--app-bg)] pb-10">
      <div className="mx-auto w-full max-w-7xl px-4 py-5 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-start justify-between gap-4">
          ...
          {!selectedLocationId && (
            <div className="md:hidden w-full relative z-10 pt-2">
              <div className="overflow-hidden rounded-[28px] border border-zinc-200/80 bg-white/88 px-4 py-4 shadow-[0_18px_40px_rgba(15,23,42,0.08)] backdrop-blur-xl dark:border-white/8 dark:bg-zinc-900/82 dark:shadow-[0_20px_44px_rgba(0,0,0,0.32)]">
                <span className="page-kicker text-orange-500">LOCATION</span>
                <h1 className="page-title page-title-compact mt-1 text-zinc-900 dark:text-white">LOCATION</h1>
          ...
          <div className={`fixed bottom-6 right-6 z-50 md:static md:z-auto md:flex md:flex-wrap md:items-center md:gap-3 ${selectedLocationId ? 'hidden md:flex' : ''}`}>
            <ActionButton
              label="New Location"
              icon="add_location"
              onClick={() => {
        ...
        {editingLocation ? (
          ...
          <div className="grid gap-3 sm:gap-4 md:grid-cols-3">
            <button
              ...
              className="group rounded-[24px] sm:rounded-[30px] border border-zinc-200 bg-zinc-50 p-4 sm:p-6 text-left transition hover:border-zinc-400 hover:bg-zinc-100 dark:border-zinc-800 dark:bg-zinc-900 dark:hover:border-zinc-600 dark:hover:bg-zinc-800"
            >
              <div className="flex h-10 w-10 sm:h-14 sm:w-14 items-center justify-center rounded-[14px] sm:rounded-[20px] bg-zinc-800 text-white dark:bg-zinc-100 dark:text-zinc-950">
                <span className="material-symbols-outlined text-[20px] sm:text-[28px]">photo_camera</span>
              </div>
              <h3 className="mt-3 sm:mt-4 text-lg sm:text-xl font-semibold text-zinc-900 dark:text-white">Capture Location</h3>
              <p className="mt-1 sm:mt-2 text-xs sm:text-sm leading-5 sm:leading-6 text-zinc-500 dark:text-zinc-400">Use the native camera, auto-resolve GPS, and create a location in under 15 seconds.</p>
            </button>
            <button
              type="button"
              onClick={() => {
            ...
            >
              <div className="flex h-10 w-10 sm:h-14 sm:w-14 items-center justify-center rounded-[14px] sm:rounded-[20px] bg-zinc-800 text-white dark:bg-zinc-100 dark:text-zinc-950">
                <span className="material-symbols-outlined text-[20px] sm:text-[28px]">upload_file</span>
              </div>
              <h3 className="mt-3 sm:mt-4 text-lg sm:text-xl font-semibold text-zinc-900 dark:text-white">Upload Image</h3>
              <p className="mt-1 sm:mt-2 text-xs sm:text-sm leading-5 sm:leading-6 text-zinc-500 dark:text-zinc-400">Upload an image, search for the location, and store exact coordinates with Mapbox suggestions.</p>
            </button>
            <button
              type="button"
              onClick={() => {
            ...
            >
              <div className="flex h-10 w-10 sm:h-14 sm:w-14 items-center justify-center rounded-[14px] sm:rounded-[20px] bg-zinc-800 text-white dark:bg-zinc-100 dark:text-zinc-950">
                <span className="material-symbols-outlined text-[20px] sm:text-[28px]">pin_drop</span>
              </div>
              <h3 className="mt-3 sm:mt-4 text-lg sm:text-xl font-semibold text-zinc-900 dark:text-white">Drop Location</h3>
              <p className="mt-1 sm:mt-2 text-xs sm:text-sm leading-5 sm:leading-6 text-zinc-500 dark:text-zinc-400">Paste a Google Maps link, Mapbox URL, coordinates, or address text. ProdSync resolves the location for you.</p>
            </button>
          </div>
        ) : createMode === 'capture' ? (
          <div className="space-y-5">
      ...
      {selectedLocationId && (
        <div className="md:hidden">
          <LiquidGlassNavbar
            ...
            onTabChange={(id) => handleWorkspaceTabSwitch(selectedLocationId, id as WorkspaceTab)}
